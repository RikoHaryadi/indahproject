...
{{-- Pilih Pelanggan --}}
        ...
        <table class="table">
            <thead class="bg-gray-100 text-xs uppercase text-gray-600">
                <tr>
                    ...
                    <th class="px-2 py-1 border hide-mobile">Isi</th>
                    <th class="px-2 py-1 border hide-mobile">Quantity</th>
    ...
    <button type="button" id="add-item" class="btn btn-primary mt-2" onclick="addNewItem()">Tambah Item</button>
</div>
    <div>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    /* Sembunyikan kolom isidus dan quantity */
    .hide-mobile {
